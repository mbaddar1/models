...
def sample_data(data_type, num_contexts=None):
    ...
    Returns:
      datasets: Sampled matrix with rows: (context, reward_1, ..., reward_num_act).
...
def main(_):
    ...
    NUM_ACTIONS_PARAM = hp.HParam('num_actions', hp.Discrete([num_actions]))
    hparams = {'num_actions': NUM_ACTIONS_PARAM}
    algos = [
